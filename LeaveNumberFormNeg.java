...
public class LeaveNumberFormNeg extends TestBase{

    String testId = "PLUS_LEAVE_NUMBER_NEG";
    ...
    public void asUserCompletesFormLeaveNumber_WeWillCallYouBackWithInvalidPhoneNumberField(String phoneNumber, String email, String retentionPhoneNumber, String invalidPhoneNumber, String invalidEmail) throws InterruptedException{
        Rodo rodo = new Rodo();
        ...
        formLeaveTheNumberPage.typeInPhoneNumberField(invalidPhoneNumber);
        ...
        formLeaveTheNumberPage.validationMessageToInvalidPhoneNumberField();
    }
    ...
    public void asUserCompletesFormLeaveNumber_WeWillCallYouBackWithInvalidEmailField(String phoneNumber, String email, String retentionPhoneNumber, String invalidPhoneNumber, String invalidEmail) throws InterruptedException{
        Rodo rodo = new Rodo();
        rodo.clickOnAcceptRodoButton();
        ...
        formLeaveTheNumberPage.typeInEmailField(invalidEmail);
        formLeaveTheNumberPage.expandTheDropDownListWithLabelSelectConversationTopic();
        formLeaveTheNumberPage.clickDataValueInternetOnPlusNetwork();
        formLeaveTheNumberPage.clickExpandShowingAllConsentsButton();
        formLeaveTheNumberPage.clickConsentToTheProcessingOfPersonalDataThroughCheckBox();
        ...
        formLeaveTheNumberPage.informationClauseForDownload();
        formLeaveTheNumberPage.clickFormButton();
        formLeaveTheNumberPage.validationMessageToInvalidEmailField();
    }
